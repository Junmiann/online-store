...
def user_order_details(order_id):
    ...
    return render_template("/orders/order_details.html", user=user, order_id=order_id, user_orders_details=user_orders_details, user_order_products=user_order_products)